...
def image_to_base64(image):
    buffered = BytesIO()
    image.save(buffered, format="PNG")import streamlit as st
from PIL import Image
import base64
from io import BytesIO
...
# 4. Function to convert image to base64
def image_to_base64(image):
...
# 5. Function to create a project tile with HTML
...
# 7. Number of columns per row
cols_per_row = 2

# 8. Create the grid of tiles using Streamlit's columns
